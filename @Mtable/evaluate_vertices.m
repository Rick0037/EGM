function J_out = evaluate_vertices(Mtable,vertices_to_evalue)
    ...
    vertices_to_evalue = round(vertices_to_evalue,4);
    ...
    pubishedVertices = punish_outLimit(Mtable,vertices_to_punish);
    vertices_evalued = [vertices_evalued;pubishedVertices]; 
